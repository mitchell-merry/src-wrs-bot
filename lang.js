export default {
    ...
    'LINK_INVALID_KEY': 'Invalid API key. Please retrieve your API key from [here](https://www.speedrun.com/api/auth), and do not regenerate your key until the confirmation message is sent. Or, send "unlink" here to unlink your discord account, if any. If you believe this is in error, please contact diggitydingdong#3084.',
    ...
    'TRACK_INFO_FOUND': 'Found game and category!',
};